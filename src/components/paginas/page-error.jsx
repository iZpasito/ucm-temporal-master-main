...
function PageError() {
  return (
      <div className='h-screen min-w-375 max-h-667'>
        <Navno></Navno>
    ...
    <div className="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
        ...
        <p className="text-gray-500 mt-4 pb-4 border-b-2 text-center">La pagina no ha sido encontrada, Page Not Found.</p>
        <Link href="#" className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150" title="Return Home">
            ...
            <NavLink to='/'>Devuelta al Login</NavLink>
        </Link>
    </div>
</div>
      </div>
